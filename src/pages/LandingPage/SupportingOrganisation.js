            ...
            <section className="section bg-light" id="marketplace">
                <Container>
                    ...
                    <Row className='justify-content-center'>
                        ...
                        <p>The materials contained in the ESG Recognition Scheme Platform website have been developed solely for the purpose of providing general information about the operations, services and activities of the ESG Recognition Scheme Platform. Whilst every effort has been made to ensure the accuracy of the information provided in this website, The Hong Kong Construction Association, Limited (HKCA), under no circumstances, accepts no responsibility or liability for any loss or damage caused, whether occasioned by negligence, misstatement, omissions or inaccuracies in this website. The information presented is subject to change at any time and without notice.</p>
                        <p>You agree and understand that the information, materials, services and software available in the ESG Recognition Scheme Platform website are provided on an “as is", “as available" basis without warranties of any kind (express or implied). In particular, no warranty or representation regarding accuracy, timeliness, reliability, completeness, freedom from computer virus, security, non-infringement or fitness for a particular purpose is given in conjunction with such information, materials, services or software. To the extent permitted by law, HKCA disclaims all warranties (express or implied) of satisfactory quality, fitness for a particular purpose or non-infringement. All such implied terms and warranties are hereby excluded.</p>
                    ...
                    <Row className="justify-content-center">
                        <p>ESG Recognition Scheme Platform website uses SSL/TLS protocol to encrypt data during network transmission to protect your data. All data you provide to the HKCA via this website are secured, and access to them is restricted to authorised personnel only. HKCA will not disclose your data to any third parties without your prior consent.</p>
