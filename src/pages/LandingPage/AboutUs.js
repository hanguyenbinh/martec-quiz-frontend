                    ...
                    <Row className="justify-content-center">
                        <Col lg={8}>
                            <div className="text-center mb-5">
                                ...
                                <p className="text-muted ">To support and encourage the construction industries take positive initiatives in the area of ESG, the Hong Kong Construction Association (HKCA) allocated HKD 10 million to establish the ESG Recognition Scheme. The scheme including: </p>
                            </div>
                        </Col>
                    </Row>
